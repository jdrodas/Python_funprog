...
### [EntradaDatos](https://github.com/jdrodas/Python_funprog/tree/main/EntradaDatos)
...
### [EjemploCondicionales](https://github.com/jdrodas/Python_funprog/tree/main/EjemploCondicionales)
- Demostrar el funcionamiento de los condicionales utilizando operadores de igualdad y operadores lógicos.
- Actualizado a Python 3.14.x

### [EjemploCicloWhile](https://github.com/jdrodas/Python_funprog/tree/main/EjemploCicloWhile)
...
### [PatronesAsteriscos](https://github.com/jdrodas/Python_funprog/tree/main/PatronesAsteriscos)
- Demostrar el funcionamiento del ciclo de control While, generando patrones de asteriscos en forma de arbolitos.
- Actualizado a Python 3.14.x

### [RegistroConsumoAgua](https://github.com/jdrodas/Python_funprog/tree/main/RegistroConsumoAgua)
- Demostrar el funcionamiento del ciclo de control While, Condicionales, contadores y totalizadores.
- Actualizado a Python 3.14.x

### [RegistroHuellaCarbono](https://github.com/jdrodas/Python_funprog/tree/main/RegistroHuellaCarbono)
- Demostrar el funcionamiento del ciclo de control While, Condicionales, contadores y totalizadores.
- Actualizado a Python 3.14.x

### [PesoCachorroVeterinaria](https://github.com/jdrodas/Python_funprog/tree/main/PesoCachorroVeterinaria)
- Demostrar el funcionamiento del ciclo de control While, Condicionales, contadores y totalizadores.
- Actualizado a Python 3.14.x

### [AdivinaAleatorio](https://github.com/jdrodas/Python_funprog/tree/main/AdivinaAleatorio)
- Demostrar el funcionamiento del ciclo de control While, Condicionales, contadores y totalizadores.
- Actualizado a Python 3.14.x

### [AnalisisTemperatura](https://github.com/jdrodas/Python_funprog/tree/main/AnalisisTemperatura)
- Demostrar el funcionamiento del ciclo de control While, Condicionales, contadores y totalizadores.
- Actualizado a Python 3.14.x

### [IndiceMasaCorporal](https://github.com/jdrodas/Python_funprog/tree/main/IndiceMasaCorporal)
- Demostrar el funcionamiento del control de excepciones usando try-except, en combinación con el ciclo while
- Actualizado a Python 3.14.x

### [TablasMultiplicar](https://github.com/jdrodas/Python_funprog/tree/main/TablasMultiplicar)
- Demostrar el funcionamiento del ciclo for, range y el concepto de los ciclos anidados
- Actualizado a Python 3.14.x

### 3. Funciones

### [EjemploFunciones](https://github.com/jdrodas/Python_funprog/tree/main/EjemploFunciones)
- Demostrar el funcionamiento de las funciones, los parametros y los tipos de retorno.
- Actualizado a Python 3.14.x

### [ConvierteTiempo](https://github.com/jdrodas/Python_funprog/tree/main/ConvierteTiempo)
...
### [NumerosAmigos](https://github.com/jdrodas/Python_funprog/tree/main/NumerosAmigos)
...
### [NumeroNarcisista](https://github.com/jdrodas/Python_funprog/tree/main/NumeroNarcisista)
- Identificar si un número entero de tres cifras es narcisista
- Actualizado a Python 3.14.x

### [RiesgosInundaciones](https://github.com/jdrodas/Python_funprog/tree/main/RiesgosInundaciones)
- Crear una aplicación de consola que permita cuantificar la afectación de hogares por inundaciones
- Actualizado a Python 3.14.x

### [PavimentacionCalles](https://github.com/jdrodas/Python_funprog/tree/main/PavimentacionCalles)
...
### [EjemploListas](https://github.com/jdrodas/Python_funprog/tree/main/EjemploListas)
- Demostración inicial del funcionamiento y manipulación de elementos de una lista
- Actualizado a Python 3.14.x

### [ListaEnterosAleatorios](https://github.com/jdrodas/Python_funprog/tree/main/ListaEnterosAleatorios)
...
### [CodigoMurcielago](https://github.com/jdrodas/Python_funprog/tree/main/CodigoMurcielago)
- Demostración del uso de listas con funciones
...
### [TransicionEnergeticaListas](https://github.com/jdrodas/Python_funprog/tree/main/TransicionEnergeticaListas)
- Demostración del uso de listas con funciones
- Utilizar listas para optimizar la declaración de variables
- Actualizado a Python 3.14.x

### [ColonizacionMarteListas](https://github.com/jdrodas/Python_funprog/tree/main/ColonizacionMarteListas)
- Demostración del uso de listas con funciones
- Utilizar listas para optimizar la declaración de variables
- Actualizado a Python 3.14.x

### [IdentificaPalindromos](https://github.com/jdrodas/Python_funprog/tree/main/IdentificaPalindromos)
...
### [EjemploDiccionarios](https://github.com/jdrodas/Python_funprog/tree/main/EjemploDiccionarios)
- Demostración inicial del funcionamiento y manipulación de un dicicionario
- Actualizado a Python 3.14.x

### [TransicionEnergeticaDiccionario](https://github.com/jdrodas/Python_funprog/tree/main/TransicionEnergeticaDiccionario)
- Demostración del uso de listas con funciones
- Utilizar diccionarios para optimizar la declaración de variables
- Actualizado a Python 3.14.x

### [ColonizacionMarteDiccionario](https://github.com/jdrodas/Python_funprog/tree/main/ColonizacionMarteDiccionario)
- Demostración del uso de diccionarios con funciones
- Utilizar diccionario para optimizar la declaración de variables
- Actualizado a Python 3.14.x

### [EjemploPilasColas](https://github.com/jdrodas/Python_funprog/tree/main/EjemploPilasColas)
- Demostración inicial del funcionamiento y diferencias entre una pila y una cola
- Actualizado a Python 3.14.x

### [CafeteriaEncolada](https://github.com/jdrodas/Python_funprog/tree/main/CafeteriaEncolada)
- Aplicación de una cola para gestionar clientes de una cafeteria
- Actualizado a Python 3.14.x

### [AbordajeAvionUsandoColas](https://github.com/jdrodas/Python_funprog/tree/main/AbordajeAvionUsandoColas)
...
### [MaterialesConstruccion](https://github.com/jdrodas/Python_funprog/tree/main/MaterialesConstruccion)
...
### [MetodosOrdenamiento](https://github.com/jdrodas/Python_funprog/tree/main/MetodosOrdenamiento)
...
### [TiendaBicicletasArchivosCSV](https://github.com/jdrodas/Python_funprog/tree/main/TiendaBicicletasArchivosCSV)
...
### [TiendaBicicletasArchivosXML](https://github.com/jdrodas/Python_funprog/tree/main/TiendaBicicletasArchivosXML)
...
### [TiendaBicicletasArchivosJSON](https://github.com/jdrodas/Python_funprog/tree/main/TiendaBicicletasArchivosJSON)
...
### [TiendaBicicletasArchivosYAML](https://github.com/jdrodas/Python_funprog/tree/main/TiendaBicicletasArchivosYAML)
...
### [Ex01_FumigacionesConjuntoResidencial](https://github.com/jdrodas/Python_funprog/tree/main/Ex01_FumigacionesConjuntoResidencial)
- Tema de examen 01: Condicionales y Ciclos de control. Fumigaciones en Conjunto Residencial. 
- Actualizado a Python 3.14.x

### [Ex01_DiversificacionProduccionLechera](https://github.com/jdrodas/Python_funprog/tree/main/Ex01_DiversificacionProduccionLechera)
- Tema de examen 01: Condicionales y Ciclos de control. Diversificación Producción Lechera. 
- Actualizado a Python 3.14.x

### Examen No. 2

### [Ex02_TransicionEnergetica](https://github.com/jdrodas/Python_funprog/tree/main/Ex02_TransicionEnergetica)
- Tema de examen 02: Funciones, Control de errores. Monitoreo Generación Energía. 
- Actualizado a Python 3.14.x

### [Ex02_ColonizacionMarte](https://github.com/jdrodas/Python_funprog/tree/main/Ex02_ColonizacionMarte)
...
### [Ex03_PedidosPasteleria](https://github.com/jdrodas/Python_funprog/tree/main/Ex03_PedidosPasteleria)
- Tema de examen 03: Funciones, Control de errores, Listas y diccionarios. Gestión pedidos para pastelería. 
- Actualizado a Python 3.14.x

### [Ex03_AbastecimientoMedicamentos](https://github.com/jdrodas/Python_funprog/tree/main/Ex03_AbastecimientoMedicamentos)
- Tema de examen 03: Funciones, Control de errores, Listas y diccionarios. Abastecimiento de medicamentos. 
- Actualizado a Python 3.14.x

### Recuperatorios

### [Rec01_EmpanadasGourmet](https://github.com/jdrodas/Python_funprog/tree/main/Rec01_EmpanadasGourmet)
